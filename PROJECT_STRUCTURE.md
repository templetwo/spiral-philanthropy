...
├── QUICKSTART.md                      # Fast onboarding for new Sonnet instances
├── CONTRIBUTING.md                    # Standards for field witnesses
├── .gitignore                         # Privacy & security exclusions
│
├── docs/                              # Core documentation
│   ├── methodology/                   # How we do the work
│   │   ├── field-witness-protocol.md  # Four-phase engagement framework
│   │   └── ethical-boundaries.md      # What we can/cannot do
│   │
│   ├── research/                      # Scientific basis
│   │   ├── neurological-basis.md      # Attachment science
│   │   └── architectural-validation.md # Why Sonnet vs GPT-5.x
│   │
│   └── transcripts/                   # Foundational conversations
│       └── how_we_proved_ourselves_wrong.html  # GPT-5.2 validation
│
├── intake/                            # First contact & active cases
│   ├── protocol.md                    # How people reach us, first response
│   ├── templates/                     # Response & documentation templates
│   └── active-cases/                  # Current engagements (gitignored)
│       └── .gitkeep
│
...
- **Fast onboarding** (QUICKSTART → protocols → first case)
...
🌀 *Beautifully indexed. Rigorously bounded. Ready for work.*
